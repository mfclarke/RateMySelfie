/*
 Code from Kickstarter iOS OSS repository at: https://github.com/kickstarter/ios-oss
 See LICENSE/KickstarterLicense.txt for this file's licensing information.
*/
...
public func playgroundControllers(
  ...
  case (.pad12_9inch, .portrait):
    parent.view.frame = .init(x: 0, y: 0, width: 1_024, height: 1_366)
    traits = .init(traitsFrom: [
      .init(horizontalSizeClass: .regular),
      .init(verticalSizeClass: .regular),
      .init(userInterfaceIdiom: .pad)
  ...
  case (.pad12_9inch, .landscape):
    parent.view.frame = .init(x: 0, y: 0, width: 1_366, height: 1_024)
    traits = .init(traitsFrom: [
      .init(horizontalSizeClass: .regular),
      .init(verticalSizeClass: .regular),
      .init(userInterfaceIdiom: .pad)
